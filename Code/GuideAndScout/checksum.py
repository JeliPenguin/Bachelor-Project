...
def checkReceiverChecksum(ReceivedMessage, k, Checksum):
    ...
    ReceiverSum = bin(int(c1, 2)+int(c2, 2) +
    ...
    for i in ReceiverSum:
        if(i == '1'):
            ...
            ReceiverChecksum += '1'
    return int(ReceiverSum) == 0


# Driver Code
SentMessage = "10010101011000111001010011101100"
k = 8
# ReceivedMessage = "10010101011000111001010011101111"
...
final = checkReceiverChecksum(ReceivedMessage, k, Checksum)
